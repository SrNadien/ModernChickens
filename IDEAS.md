...
## Scratch 
- While using modern chickens i have found that my rooster will not breed with any chickens whatsoever. 
- Chickens seem to be spawning endlessly around the player - we need to mitigate and normalize the modern chicken  and vanilla chicken spawns
- Roosters need to be added to spawn pool
